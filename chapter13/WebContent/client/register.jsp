					...
					<td style="padding: 30px"><h1>新用户注册</h1>
						<table width="70%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="width: 40%">
								<input type="text" class="textinput"  id="email" name="email" onkeyup="checkEmail();" value="${param.email}" />
								</td>
								<td colspan="2"><span id="emailMsg"></span><font color="#999999">请输入有效的邮箱地址</font></td>
							</tr>
							<tr>
								<td style="text-align: right">用户名：</td>
								<td><input type="text" class="textinput"  id="username" name="username" onkeyup="checkUsername();" value="${param.username}" />
								</td>
								<td colspan="2"><span id="usernameMsg"></span><font color="#999999">字母数字下划线1到10位, 不能是数字开头</font>&nbsp;${param.username}${usernameError}</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<input type="text" class="textinput"
									style="width: 350px" name="telephone" value="${param.telephone}" />
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								...
								<td colspan="2">
								<textarea class="textarea" name="introduce" >${param.introduce}</textarea>
								</td>
								<td>&nbsp;</td>
							</tr>
						</table>
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="width: 50%">
								<input type="text" class="textinput" name="userCode"/>&nbsp;${codeError}
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
