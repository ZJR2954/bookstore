				    ...
				    <table width="60%" border="0" cellspacing="0" style="margin-top:70px">
						<tr>
							...
							<td style="padding-top:30px">
								<font style="font-weight:bold; color:#FF0000">亲，订单生成成功，请到“我的账户”-“<a href="${pageContext.request.contextPath }/findOrderByUser">订单查询</a>”中支付！</font><br /> <br />
								<a href="${pageContext.request.contextPath }/findOrderByUser">
									<span id="second">5</span>秒后自动为您转跳回订单页</a>
							</td>
						</tr>
					</table>
				  <h1>&nbsp;</h1>
