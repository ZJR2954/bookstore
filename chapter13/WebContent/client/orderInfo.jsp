...
<body class="main">
		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				<td>
					...
					<form action="${pageContext.request.contextPath}/client/pay.jsp" method="get" >
									...
									<tr>
										<td>
											...
											<table cellspacing="1" class="carttable">
												<tr>
													<td style="text-align:right; padding-right:40px;"><font
														style="color:#FF0000">订单合计：&nbsp;&nbsp;${order.money}</font>
													</td>
												</tr>
											</table>
											<p>
											...
											<p style="text-align:right">
												<input type="image" src="${pageContext.request.contextPath }/client/images/gif53_030.gif" width="204" height="51" border="0" />
											</p>
											</c:if>
										</td>
									</tr>
	...
	<%
		Object payOrder=request.getAttribute("order");
