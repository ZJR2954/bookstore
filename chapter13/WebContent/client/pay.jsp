...
<body>
	...
	<form action="${pageContext.request.contextPath}/pay" method="post">
		订单号：<INPUT TYPE="text" NAME="orderid" value="${payOrder.id}" disabled="disabled" style="width:260px;">
		支付金额：<INPUT TYPE="text" NAME="money" value="${payOrder.money}" disabled="disabled" style="width:100px;">元
		<div class="divBank">
