										...
										<tr>
											<td>
												...
												<c:forEach items="${cart}" var="entry" varStatus="vs">
													<table width="100%" border="0" cellspacing="0">
														<tr>
															...
															<td width="10%"><fmt:formatNumber type="number" value="${entry.key.price*entry.value}" maxFractionDigits="2" /></td>
														</tr>
													</table>
												...
												<table cellspacing="1" class="carttable">
													<tr>
														<td style="text-align:right; padding-right:40px;"><font
															style="color:#FF0000">合计：&nbsp;&nbsp;
															<fmt:formatNumber type="number" value="${totalPrice}" maxFractionDigits="2" />元
															</font>
												...
												<p style="text-align:right">
													...
													<c:if test="${user == null }">
													<br /><br />★还没登陆？<a href="${pageContext.request.contextPath}/client/login.jsp">去登陆</a>
													</c:if>
													<c:if test="${empty cart == true }">
													<br /><br />★购物车为空？<a href="${pageContext.request.contextPath}/showProductByPage">去购物</a>
													</c:if>
												</p>
											</td>
										</tr>
