...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/manager/findProductByManyCondition"
		method="post">
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${ps}" var="p">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%">
										<a href="${pageContext.request.contextPath}/manager/deleteProduct?id=${p.id}" onclick="javascript:return p_del()">
